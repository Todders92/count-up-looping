...
#### _A Web Page Displaying Numbers, January 2020_

#### By _**Todd Walraven**_

## Description

_This application has the user enter a number to count by and what number to count up to. The application uses JQuery and JavaScript to handle the logic involved._
